 ...
 *   $config['additional_javascript'][] = 'inc/scripts/infinite-scroll.js';
 *
 */
...
var load_next_page = function() {
	...
	var boardheader = $('<h2>'+'Page'+' '+next_page.html()+'</h2>');
	var loading_ind = $('<h2>'+'Loading...'+'</h2>').insertBefore('#post-moderation-fields');
...
var button = $("<a href='#all'>"+"All"+" </a>").prependTo(".pages");
