 ...
 *   $config['additional_javascript'][] = 'inc/scripts/file-selector.js';
 */
...
$(document).ready(function () {
	...
	if (window.Options && Options.get_tab('general')) {
		Options.extend_tab('general', '<label id="file-drag-drop"><input type="checkbox">Drag and drop file selection</label>');
