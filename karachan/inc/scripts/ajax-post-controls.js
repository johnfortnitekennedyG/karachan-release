 ...
 *   $config['additional_javascript'][] = 'inc/scripts/ajax-post-controls.js';
 */
		...
		$form.submit(function(e) {
			...
			$.ajax({
				...
				error: function(xhr, status, er) {
					// An error occured
					// TODO
					alert('Something went wrong... An unknown error occured!');
				},
				data: formData,
				cache: false,
				contentType: false,
			...
			$($(form).data('submit-btn')).attr('disabled', true).data('orig-val', $($(form).data('submit-btn')).val()).val('Working...');
