 ...
 *   $config['additional_javascript'][] = 'inc/scripts/treeview.js';
 *
 */
...
$(function() {
	if (window.Options && Options.get_tab('general')) {
		...
		Options.extend_tab("general", "<label id='treeview-global'><input type='checkbox' /> "+'Use tree view by default'+"</label>");
...
$(function() {
	...
	$('hr:first').before('<div class="unimportant" style="text-align:right"><label for="treeview"><input type="checkbox" id="treeview"> '+'Tree view'+'</label></div>');
