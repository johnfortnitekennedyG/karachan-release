 ...
 *   $config['additional_javascript'][] = 'inc/scripts/options/user-js.js';
 */

+function(){

var tab = Options.add_tab("user-js", "code", "User JS");
...
var submit = $("<input type='button' value='"+"Update custom Javascript"+"'>").css({
  position: "absolute",
  height: 25, bottom: 5,
  width: "calc(100% - 10px)",
  left: 5, right: 5
...
var update_textarea = function() {
  if (!localStorage.user_js) {
    textarea.text("/* "+"Enter here your own Javascript code..."+" */\n" +
