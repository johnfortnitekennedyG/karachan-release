 ...
 *   $config['additional_javascript'][] = 'inc/scripts/jquery-ui.custom.min.js';
 *   $config['additional_javascript'][] = 'inc/scripts/ajax.js';
 *   $config['additional_javascript'][] = 'inc/scripts/wPaint/8ch.js';
...
oekaki.init = function() {
  ...
  $('<link class="wpaintcss" rel="stylesheet" href="/inc/scripts/wPaint/wPaint.min.css" />').appendTo($("head"));
  $('<link class="wpaintcss" rel="stylesheet" href="/inc/scripts/wPaint/lib/wColorPicker.min.css" />').appendTo($("head"));
  $('<link class="wpaintcss" rel="stylesheet" href="/assets/jquery-ui/core.css" />').appendTo($("head"));
  $('<link class="wpaintcss" rel="stylesheet" href="/assets/jquery-ui/resizable.css" />').appendTo($("head"));
  $('<link class="wpaintcss" rel="stylesheet" href="/assets/jquery-ui/theme.css" />').appendTo($("head"));
...
oekaki.load_img = function() {
  alert("Click on any image on this site to load it into oekaki applet");
